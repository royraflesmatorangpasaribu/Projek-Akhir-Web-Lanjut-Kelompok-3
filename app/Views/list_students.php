                    ...
                    <tbody>
                        ...
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                ...
                                <td><?= $user->name; ?></td>
                                <td > 
                                    <a href="<?= base_url('parents/students/detail/' . $user->userid) ?>" class="btn btn-success" style="margin-left:10px">Detail</a>
...
<script>
    function searchStudents() {
        ...
        rows.forEach(function(row) {
            ...
            // Check if the search input is found in any of the columns
            if (username.includes(searchInput) || email.includes(searchInput) || name.includes(searchInput)) {
